...
def _runcapture(bounds, config, seed: int, num_cycles: int, num_arms: int):
...
def test_001():
    ...
    fixture_path = FIXTURES_DIR / "goldopteseed42.json"
    ...
    captured = _runcapture(bounds, config, seed, num_cycles, num_arms)
