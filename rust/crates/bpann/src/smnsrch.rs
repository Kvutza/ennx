...
use crate::distance::{bpann_f32, l2_f32};
use crate::merge::merge_dist;
...
pub fn load_or_build_small_n_cache(
    ...
    for i in 0..n {
        let row = backend.train_x.row_slice(i)?;
        bpann_f32(row, backend.scale_x, x_scale, &mut buf);
