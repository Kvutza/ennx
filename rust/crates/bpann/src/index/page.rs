...
impl Page {
    ...
    pub fn deserialize(data: &[u8]) -> Result<Self, String> {
        ...
        match kind {
            ...
            1 => Self::leaf_full(data, page_id, num_dim, off),
            2 => Self::leaf_centroid(data, page_id, num_dim, off),
            3 => Self::leaf_range(data, page_id, num_dim, off),
    ...
    fn read_vec(data: &[u8], off: &mut usize, num_dim: usize) -> Result<Vec<f32>, String> {
    ...
    fn deserialize_internal(
        ...
        for _ in 0..n {
            ...
            centroids.push(Self::read_vec(data, &mut off, num_dim)?);
        }
        Ok(Page::Internal {
            page_id,
            centroids,
    ...
    fn leaf_full(
        ...
        for _ in 0..n {
            ...
            vectors.push(Self::read_vec(data, &mut off, num_dim)?);
        }
        Ok(Page::Leaf {
            page_id,
            row_ids,
    ...
    fn leaf_centroid(
        ...
        let centroid = Self::read_vec(data, &mut off, num_dim)?;
        Ok(Page::Leaf {
            page_id,
            row_ids,
            row_range: None,
    ...
    fn leaf_range(
        ...
        let centroid = Self::read_vec(data, &mut off, num_dim)?;
        Ok(Page::empty_leaf(page_id, start, end, centroid))
    }
}

pub fn write_index(pages: &[Page], num_dim: usize, w: &mut impl Write) -> std::io::Result<()> {
...
pub fn read_index(r: &mut impl Read) -> std::io::Result<Vec<Page>> {
...
mod tests {
    ...
    fn btree_roundtrip() {
        ...
        let mut buf = Vec::new();
        write_index(&pages, 2, &mut buf).unwrap();
        let mut cursor = Cursor::new(buf);
        let back = read_index(&mut cursor).unwrap();
    ...
    #[test]
    fn range_list() {
        let page = Page::empty_leaf(7, 100, 1100, vec![1.0, 2.0]);
