...
pub fn generate_candidates<R: Rng + ?Sized>(
    compute_bounds: impl Fn() -> (Array1<f64>, Array1<f64>),
    ...
    let (lower_1d, upper_1d) = compute_bounds();
...
fn raasp_cdf(cdf: &Array1<f64>, r: f64, num_dim: usize) -> usize {
    let mut lo = 0usize;
