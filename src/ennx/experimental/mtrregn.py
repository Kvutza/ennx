...
from .mtrregnpol import SharingPolicy
from .mtrregntypes import (
    CandidateProposal,
    RegionBatch,
    RegionCandidate,
    RegionRound,
...
def _policy(sharing_policy: SharingPolicy | str) -> str:
...
def make_region(
    ...
    return MultiTrustRegion(
        ...
        sharing_policy=_policy(sharing_policy),
        seed=seed,
    )
...
class MultiTrustRegionLoop:
    ...
    def allocate(
        ...
        return allocate_batches(self.state, budget, utility)
    ...
    def propose(
        ...
        for batch in batches:
            ...
            for candidate in produced:
                proposals.append(_coerceproposal(candidate))
    ...
    def score(
        ...
        for index, proposal in enumerate(map(_coerceproposal, proposals)):
            scored.append(
                RegionCandidate(
                    index=index,
    ...
    def select(
        ...
        return select_candidates(self.state, candidates, num_arms)
